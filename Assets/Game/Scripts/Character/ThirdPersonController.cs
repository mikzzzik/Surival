...
namespace Character
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        [SerializeField] private float _rroundedRadius = 0.28f;
        ...
        private void GroundedCheck()
        {
            ...
            _grounded = Physics.CheckSphere(spherePosition, _rroundedRadius, _groundLayers,
        ...
        private void OnFootstep(AnimationEvent animationEvent)
        {
            if (animationEvent.animatorClipInfo.weight > 0.5f)
            {
                if (_footstepAudioClips.Length > 0)
                {
                    ...
                    AudioSource.PlayClipAtPoint(_footstepAudioClips[index], transform.TransformPoint(_controller.center), FootstepAudioVolume);
                }
            }
        }
        ...
        private void OnLand(AnimationEvent animationEvent)
        {
            if (animationEvent.animatorClipInfo.weight > 0.5f)
            {
                AudioSource.PlayClipAtPoint(_landingAudioClip, transform.TransformPoint(_controller.center), FootstepAudioVolume);
            }
        }
    }
}